...
const selectedTabClassName =
  'border-app-foreground bg-transparent text-app-foreground lg:border-(--ds-color-border) lg:bg-(--ds-color-surface) lg:shadow-(--ds-shadow-tab) lg:hover:bg-(--ds-color-surface)';
